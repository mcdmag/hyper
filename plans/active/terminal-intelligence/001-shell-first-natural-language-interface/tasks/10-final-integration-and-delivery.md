...
- [ ] Exercise the isolated unpacked Windows app to confirm one Hyper GUI, no child top-level window, and no dangling descendant; verify the real Codex `windowsHide: true` and cleanup contract through the provider seam.
