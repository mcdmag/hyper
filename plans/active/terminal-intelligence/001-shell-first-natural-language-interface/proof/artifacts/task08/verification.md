...
Verified on Windows x64 on 2026-07-22 against the unpacked application built from this task's source tree.

## Automated gates

- `pnpm test`: passed lint and 110 unit/integration tests. The suite includes executable PowerShell 7 and Windows PowerShell 5.1 node-pty seams, 10,000-dispatch latency tests, provider cold-path assertions, anti-spoofing, pane isolation, immutable approval, and exact-once write behavior.
